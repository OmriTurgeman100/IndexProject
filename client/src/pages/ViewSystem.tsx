...
import { ViewSystemFiles } from "../components/ViewSystemFiles";
        ...
        >
            ...
            >
              ...
              >
                ...
                <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                  ...
                  >
                    <img src={system_logo} style={{ width: 32, height: 32 }} />
                  </Box>
                </Box>
              </Box>
              ...
              >
                ...
                <Box
                  onClick={() => navigate(`/tree/${id}/system`)}
                  sx={{
            ...
            >
              ...
              item.infrastructure_type.trim() !== "" ? (
                ...
                >
                  ...
                  >
                    <Typography sx={{ fontSize: "20" }}>סוג תשתית</Typography>
          ...
          {hasDeploymentSites && (
            ...
            >
              ...
              >
                אתרים בהם המערכת פרוסה ופועלת בפועל
              </Typography>
            </Box>
          )}
          ...
          {depList && depList.length > 0 ? (
            ...
            >
              ...
              >
                רשימת מערכות, שירותים או רכיבים חיצוניים שבהם המערכת תלויה לצורך
                תפקודה התקין
              </Typography>
            </Box>
          ) : null}
          ...
          {authList && authList.length > 0 ? (
            ...
            >
              ...
              >
                ...
                <AccountCircleIcon
                  sx={{ fontSize: 25, color: "text.secondary" }}
                />
              </Box>
              <Typography
                sx={{
              ...
              >
                דרכי ההתחברות שבהן המערכת משתמשת לצורך אימות זהות המשתמשים
              </Typography>
            </Box>
          ) : null}
          ...
          <Dialog open={showDocs} onClose={() => setShowDocs(false)}>
            <DialogTitle sx={{ textAlign: "center" }}>מסמכי המערכת</DialogTitle>
