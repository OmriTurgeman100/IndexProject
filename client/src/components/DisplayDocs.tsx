...
export const DisplayDocs = ({ entities, keyword, exit }: PropData) => {
    ...
    const redirect = (type: string, id: number): void => {
        switch (type) {
            case "service":
                navigate(`/docs/${id}/?type=service&keyword=${keyword}`);
                break;
            case "system":
                navigate(`/docs/${id}/?type=system&keyword=${keyword}`);
                break;
        }
    };
