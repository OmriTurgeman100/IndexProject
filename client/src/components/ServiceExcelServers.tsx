...
import { upload_service_servers_excel } from "../services/Service";
...
export const ServiceExcelServers = ({ service_id, show_upload, close_upload, refresh, open_servers }: PropData) => {
    ...
    const handleUpload = async (e: React.FormEvent) => {
        setLoading(true)
        e.preventDefault();
        await upload_service_servers_excel(service_id as string, file as File);
